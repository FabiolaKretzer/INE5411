.data
_vetor: .word 5:XY_total	# Cria a matriz na memória com todos os seus elementos iguais a "5"
.text
li $s6, X_linhas			# $s6 = número total de linhas
li $s7, Y_colunas 			# $s7 = número total de colunas
